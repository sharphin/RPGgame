...
public class Title extends JPanel{
    ...
    public void paintComponent(Graphics g) {//ここは全員の書き換えを許可
        ...
        g.setColor(Color.WHITE);
        g.drawString("定時退社RPG",155,160);
        g.drawString("開始する",180,280);
        g.drawString("ロード",190,330);
        g.drawString("終了する",180,375);
        g.setColor(cyan);
